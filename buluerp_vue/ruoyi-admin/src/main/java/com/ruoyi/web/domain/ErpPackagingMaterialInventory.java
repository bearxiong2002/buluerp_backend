...
public class ErpPackagingMaterialInventory {
    ...
    // 私有构造方法（Builder专用）
    private ErpPackagingMaterialInventory(Builder builder) {
        this.id = builder.id;
    ...
    // 空参构造方法（MyBatis等框架需要）
    public ErpPackagingMaterialInventory() {}
    ...
    public static class Builder {
        ...
        public ErpPackagingMaterialInventory build() {
            return new ErpPackagingMaterialInventory(this);
        }
    }
}